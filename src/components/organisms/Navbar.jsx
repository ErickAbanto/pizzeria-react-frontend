  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-[#fff7e8] z-50 shadow-lg py-4 px-6 flex justify-between items-center transition-all duration-300">
      ...
      >
        <span
          className={`absolute transition-all duration-300 ${
            openMenu ? "rotate-90 opacity-0" : "opacity-100 rotate-0"
          }`}
        >
      ...
      <div className="hidden lg:flex items-center gap-6">
        ...
        <Link
          to="/iniciar-sesion"
          className="flex items-center gap-2 font-medium text-black hover:text-yellow-600 transition-all duration-200"
        >
          <UserRound size={22} />
          Iniciar Sesión
        </Link>
